...
-- Databases
CREATE OR REPLACE DATABASE COMPUTE_WH;
GRANT OWNERSHIP ON DATABASE COMPUTE_WH TO ROLE DEMO_ROLE;
...
CREATE EVENT TABLE COMPUTE_WH.INTEGRATIONS.DEMO_EVENTS;
GRANT SELECT ON EVENT TABLE COMPUTE_WH.INTEGRATIONS.DEMO_EVENTS TO ROLE DEMO_ROLE;
GRANT INSERT ON EVENT TABLE COMPUTE_WH.INTEGRATIONS.DEMO_EVENTS TO ROLE DEMO_ROLE;

ALTER ACCOUNT SET EVENT_TABLE = COMPUTE_WH.INTEGRATIONS.DEMO_EVENTS;
ALTER DATABASE COMPUTE_WH SET LOG_LEVEL = INFO;
